...
public class ToolPanel extends JPanel implements ToolChangeLister{
    ...
    public ToolPanel(JPanel main) {
        ...
        add(new Toolitem("新建数据库", "database/table_edit.png", EmptyPanel.getInstance("还没有开始做呢。。。"),main,this),BorderLayout.NORTH);
        add(new Toolitem("删除数据库", "database/table_edit.png", EmptyPanel.getInstance("还没有开始做呢。。。"),main,this),BorderLayout.NORTH);
        add(new Toolitem("建表", "database/table_edit.png", EmptyPanel.getInstance("还没有开始做呢。。。"),main,this),BorderLayout.NORTH);
