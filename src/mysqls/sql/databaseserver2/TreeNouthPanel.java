...
public class TreeNouthPanel extends JPanel{

	private static TreeNouthPanel mePanel;
	public static TreeNouthPanel getMePanel() {
		if (mePanel==null) {
			mePanel=new TreeNouthPanel();
		}
		return mePanel;
