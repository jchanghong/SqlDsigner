	...
	public static JPanel getui() throws SQLException {
		...
		jTable.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					resultSet =statement.executeQuery("select "+firstColumnName+" from "+ConnectINFO.tableName+" limit "+focusedRowIndex+",1");
		...
		defaultTableModel.addTableModelListener(new TableModelListener() {
			...
			public void tableChanged(TableModelEvent e) {
				...
				//更新语句
				String updatesql = " update "+ConnectINFO.databaseName+"."+
