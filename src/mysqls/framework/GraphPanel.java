...
public class GraphPanel extends JPanel {
	 ...
	 *
	 * @param pGraph
	 *            The graph managed by this panel.
	 * @param pSideBar
	 *            the Side Bar which contains all of the tools for nodes and
	 *            edges.
	 */
	...
	/**
	 * @param pSelectionList
	 *            the new SelectedElements for the GraphPanel.
	 */
