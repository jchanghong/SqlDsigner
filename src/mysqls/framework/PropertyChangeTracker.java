...
public class PropertyChangeTracker {
	 ...
	 * 
	 * @param pGraph
	 *            the graph containing the edited node.
	 * @param pElement
	...
	static class PropertyChangeCommand implements Command {
		 ...
		 *
		 * @param pGraph
		 *            The graph of the object being changed.
		 * @param pObject
		 *            The graph element being transformed
		 * @param pPrevPropValue
		 *            The initial value
		 * @param pNewPropValue
		 *            The new value
		 * @param pIndex
		 *            Which property of the object this is, so that we can
		 *            select it
		 */
