...
public class MenuFactory {
	 ...
	 *            path
	 * @param pTarget
	 *            The object on which pMethodName will be invoked when the menu
	 *            is selected.
	 * @param pMethodName
	 *            The method to invoke when the menu is selected.
	 ...
	 *            path
	 * @param pListener
	 *            The callback to execute when the menu item is selected.
	 * @return A menu item for the action described.
	 */
