 ...
 * assumes that all its children are implicitly "contained", even though they
 * are not explicitly tracked. The list maintains the following invariants:
 *
 * 1. There are no duplicate nodes or edges. 2. A child node and its parent are
 * never in the selection list together. During the add operation, if a child
 * node is added and its parent is present, it is transparently not added. If a
 * parent node is added that transitively contains some of the nodes in the
 * selection, these are removed from the selection.
 *
...
public class SelectionList implements Iterable<GraphElement> {
	 ...
	 *
	 * @param pElement
	 *            The element to add to the list. Cannot be null.
	 */
	...
	/**
	 * @return The last element that was selected, or null if there are no such
	 *         elements.
	 */
	...
	/**
	 * @return The last Node that was selected, or null if there are no Nodes
	 *         selected.
	 */
	 ...
	 * @param pEdge
	 *            The edge to test.
	 * @return true iif the selection contains both end-points of pEdge, or
	 *         their parent.
	 */
	 ...
	 * pElement is not selected.
	 * 
	 * @param pElement
	 *            The element to remove. Cannot be null.
	 */
	 ...
	 * 
	 * @param pElement
	 *            The element to set as selected. Cannot be null.
	 */
